...
describe('Footer', () => {
    ...
    it('should render brand tagline', () => {
        render(<Footer />);
        expect(screen.getByText('Transformando ideias em experiências digitais excepcionais')).toBeInTheDocument();
    });
    ...
    it('should render contact links with correct href attributes', () => {
        ...
        const emailLink = links.find(link => link.getAttribute('href') === 'mailto:pabloviana2010@gmail.com');
        const linkedinLink = links.find(link => link.getAttribute('href') === 'https://www.linkedin.com/in/pablo-viana-santos/');
        const githubLink = links.find(link => link.getAttribute('href') === 'https://github.com/pablovianas');
    ...
    it('should render copyright text with current year', () => {
        ...
        expect(screen.getByText(new RegExp(`© ${currentYear} Pablo Viana`))).toBeInTheDocument();
    });
