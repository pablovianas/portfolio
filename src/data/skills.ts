...
export const skills: Skill[] = [
    ...
    { name: "Next.js", icon: SiNextdotjs as IconType, category: "frontend" },
    {
        ...
        icon: SiStyledcomponents as IconType,
        category: "frontend",
    },
    {
        name: "Tailwind CSS",
    ...
    {
        name: "React Query",
        icon: SiReactquery as IconType,
        category: "frontend",
    },
    {
        name: "React Router",
        icon: SiReactrouter as IconType,
        category: "frontend",
    },
    {
    ...
    {
        name: "Azure DevOps",
        icon: SiAzuredevops as IconType,
        category: "devops",
    },
    ...
    {
        name: "VS Code",
        icon: SiVisualstudiocode as IconType,
        category: "tools",
    },
